    ...
    switch ($name) {
      ...
      case 'activity_role':
        ...
        if ($values[2] == 1) {
          ...
          $query->_qill[$grouping][] = ts('Activities created by');
        }
        elseif ($values[2] == 2) {
          $query->_where[$grouping][] = " civicrm_activity_contact.record_type = 'Assignee'";
...
";
  ...
  static function buildSearchForm(&$form) {
    ...
    $activityRoles = array(1 => ts('Created by'), 2 => ts('Assigned to'), 3 => ts('Target'));
